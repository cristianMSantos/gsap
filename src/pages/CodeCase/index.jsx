...
export const CodeCase = () => {
  ...
  useGSAP(
    (context, contextSafe) => {
      ...
      const machineGun = (text) => {
        ...
        for (i = 0; i < wordCount; i++) {
          ...
          element = container.appendChild(
            document
              .createElement("h3")
              .appendChild(document.createTextNode(word)).parentNode
          );
          console.log(element);
          ...
          tl.to(
            element,
            { duration: duration, scale: 1.2, ease: "slow(0.25, 0.9)" },
            time
          )
            ...
            .to(
              element,
              { duration: duration, opacity: 1, ease: "slow(0.25, 0.9, true)" },
              time
            );
      ...
      document.getElementById("ContatoButton").addEventListener("click", () => {
        gotoSection(3, 1);
      });
