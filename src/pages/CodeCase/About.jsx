                                            ...
                                            <TabContext value={value}>
                                                <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                                                    <TabList onChange={handleChange} aria-label="lab API tabs example"
                                                        ...
                                                        <Tab label="Por que contratar a CodeCase?" value="3" />
                                                    </TabList>
                                                </Box>
                                                <TabPanel className="about-tabText" value="1">Acreditamos que as tecnologias só têm sentido quando são utilizadas para resolver problemas
                                                    reais e melhorar a vida das pessoas. Nossa missão é contribuir para um mundo mais
                                                    conectado, empático e eficiente, onde cada interação seja uma oportunidade de fortalecer
                                                    laços e promover progresso.</TabPanel>
                                                <TabPanel className="about-tabText" value="2">Visualizamos um futuro em que a tecnologia tem um propósito maior do que apenas
                                                    impulsionar a produtividade e automatizar processos. Como uma equipe de amigos
                                                    apaixonados por tecnologia e inovação, buscamos ser referência nesse ecossistema em que a
                                                    colaboração e a empatia são os pilares do sucesso.</TabPanel>
                                                <TabPanel className="about-tabText" value="3">Uma das principais vantagens de contratar a CodeCase como a sua fábrica de software, é poder
                                                    contar com uma equipe de profissionais especialistas na área de negócios e desenvolvimento
                                                    de sistemas, que irão ajudar a sua empresa a potencializar os processos e impulsionar o
                                                    crescimento do seu negócio. </TabPanel>
                                            </TabContext>
                                        </Grid>
                                    </Box>
